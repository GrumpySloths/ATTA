...
def graph(x, y, i, x_max, x_min, grad):
    ...
    scope,model=model_para_map[FLAGS.source_model]
    with slim.arg_scope(scope):
        logits_v3, end_points_v3 = model(
    ...
    x_nes_2 = 1 / 2 * x_nes
    with slim.arg_scope(scope):
        logits_v3_2, end_points_v3 = model(
    ...
    x_nes_4 = 1 / 4 * x_nes
    with slim.arg_scope(scope):
        logits_v3_4, end_points_v3 = model(
    ...
    x_nes_8 = 1 / 8 * x_nes
    with slim.arg_scope(scope):
        logits_v3_8, end_points_v3 = model(
    ...
    x_nes_16 = 1 / 16 * x_nes
    with slim.arg_scope(scope):
        logits_v3_16, end_points_v3 = model(
